...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		// 桌面背景图片（支持单张或多张随机）
		// 当前使用自定义照片（理光 + 伊尔福 PAN 400），16:9 裁切至 1920 宽
		desktop: [
			"assets/images/DesktopWallpaper/banner-d1.avif",
		],
		// 移动背景图片（支持单张或多张随机）
		// 暂时沿用主题示例图，替换为竖版照片后请改为此处路径
		mobile: [
			"assets/images/MobileWallpaper/m2.avif",
		],
		// 背景视频播放地址
			...
			links: [
				{
					...
					url: "https://github.com/bearts13",
					showName: true,
				},
				{
					name: "邮件",
					icon: "fa7-solid:envelope",
					url: "mailto:qiaoliangpop@outlook.com",
				},
				{
					name: "小红书",
					icon: "simple-icons:xiaohongshu",
					url: "https://xhslink.cn/o/8GMXeLRLKO6",
				},
				{
					name: "连牙蓝上了",
					icon: "mdi:headphones",
					url: "https://www.xiaoyuzhoufm.com/podcast/6913d7e2b7414e110abef782",
				},
				{
					name: "嘛都聊聊",
					icon: "fa7-solid:microphone-lines",
					url: "https://www.xiaoyuzhoufm.com/podcast/68e7b2bf53e5223817cd97e7",
				},
				{
					name: "RSS",
					icon: "fa7-solid:rss",
